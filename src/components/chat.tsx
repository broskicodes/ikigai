          ...
          <div className="flex-1 overflow-auto p-4 lg:p-6">
            <div className="grid gap-4">
              {messages.map((message, index) => (
                <div key={index} className={`flex items-start gap-3 ${message.role === "assistant" ? "justify-end" : "justify-start"}`}>
                  {message.role === "user" && (
                    <Avatar className="h-8 w-8">
                      <AvatarImage src="/placeholder-user.jpg" alt="Avatar" />
                    <AvatarFallback>AC</AvatarFallback>
                  ...
                  <div className={`rounded-lg p-3 text-sm ${message.role === "assistant" ? "text-primary-foreground bg-primary" : "text-primary bg-muted"}`}>
                    <p>{message.content}</p>
                  </div>
