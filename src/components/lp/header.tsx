...
export function Header() {
  ...
  const isMobile = size.width !== undefined && size.width < 640; // Adjust breakpoint as needed
  ...
  return (
    <header className="sticky top-0 z-20 mx-auto flex w-full items-center justify-between p-5  sm:px-10">
      ...
      <div className="mx-auto flex w-full max-w-5xl items-center justify-between z-[10] border-b border-muted-foreground/20 pb-2">
